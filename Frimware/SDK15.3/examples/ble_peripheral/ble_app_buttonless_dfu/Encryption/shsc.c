...
void SHSUpdate(SHS_CTX *context, BYTE *buffer, int count)
{
	/* Update bitcount */
...
void SHSFinal(BYTE *digest, SHS_CTX *context)
{
	int count;
...
static void byteReverse(UINT4 *buffer, int byteCount)
{
	UINT4 value;
	int count;
...
static void SHSTransform(SHS_CTX *context)
{
	UINT4 W[80], temp;
	int i;
