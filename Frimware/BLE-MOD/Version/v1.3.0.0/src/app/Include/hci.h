 ...
 * @param       txPhy   - Bit field of Host preferred Tx PHY. See @ref PHY_2
 * @param       rxPhy   - Bit field of Host preferred Rx PHY. See @ref PHY_2
 *
 * @return      @ref HCI_SUCCESS
 */
 ...
 *
 * @param       rxChan   - Rx Channel k=0..39, where F=2402+(k*2MHz).
 * @param       rxPhy    - Rx PHY to use. See @ref PHY_2
 ...
 * @param       txPhy       - Tx PHY to use. See @ref PHY_2
 *
 * @return      @ref HCI_SUCCESS
 */
 ...
 *
 * This command is used to set the Controller's Local Supported Features. For a complete list
 * of supported LE features, see the BT Spec
 *
 * @note
