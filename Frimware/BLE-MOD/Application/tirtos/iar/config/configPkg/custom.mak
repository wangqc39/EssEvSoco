...
linker.cmd: package/cfg/app_ble_prm3.xdl
	$(SED) 's"^\"\(package/cfg/app_ble_prm3cfg.cmd\)\"$""\"T:/OneDrive/SoundSimulator2/EssEvSoco/Frimware/BLE-MOD/Application/tirtos/iar/config/configPkg/\1\""' package/cfg/app_ble_prm3.xdl > $@
