 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = T:/OneDrive/SoundSimulator2/EssEvSoco/Frimware/BLE-MOD/Application/tirtos/iar/config/configPkg/package/cfg/app_ble_prm3");
...
__FAR__ const CT__ti_sysbios_family_arm_cc26xx_Seconds_Module__id ti_sysbios_family_arm_cc26xx_Seconds_Module__id__C = (xdc_Bits16)0x2b;
...
{
    return (xdc_runtime_Memory_HeapProxy_Handle)xdc_runtime_HeapMin_create((const xdc_runtime_HeapMin_Params *)__prms, __eb);
}
...
{
    return (const void *)&xdc_runtime_HeapMin_Module__FXNS__C;
}
