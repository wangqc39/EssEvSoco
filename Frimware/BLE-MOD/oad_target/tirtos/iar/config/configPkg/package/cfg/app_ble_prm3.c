 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = T:/OneDrive/SoundSimulator2/EssEv/EssEvMicorMax/Firmware/BLE-MOD/oad_target/tirtos/iar/config/configPkg/package/cfg/app_ble_prm3");
...
const __T1_xdc_runtime_Startup_firstFxns xdc_runtime_Startup_firstFxns__A[4] = {
    ...
    ((xdc_Void(*)(xdc_Void))((xdc_Fxn)ti_sysbios_family_arm_m3_Hwi_romInitNVIC__I)),  /* [2] */
