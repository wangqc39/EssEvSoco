...
linker.cmd: package/cfg/app_ble_prm3.xdl
	$(SED) 's"^\"\(package/cfg/app_ble_prm3cfg.cmd\)\"$""\"T:/OneDrive/SoundSimulator2/EssEv/EssEvMicorMax/Firmware/BLE-MOD/oad_target/tirtos/iar/config/configPkg/\1\""' package/cfg/app_ble_prm3.xdl > $@
